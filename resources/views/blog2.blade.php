                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->status == 1 || $item->status === 'published' || $item->status === true)
                                        <a href="{{ Route('author.change', $item->id) }}" class="badge-status-published">
                                            <span class="badge-dot badge-dot-green"></span>
                                            เผยแพร่
                                        </a>
                                    @else
                                        <a href="{{ Route('author.change', $item->id) }}" class="badge-status-draft">
                                ...
                                <td>
                                    <a href="{{ Route('author.edit', $item->id) }}" class="badge-status-edit">
